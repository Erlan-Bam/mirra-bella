  ...
  return (
    ...
    >
      ...
      <div className="sticky top-0 left-0 w-full h-screen flex flex-col items-center justify-center">
        {/* Lottie Animation */}
        <div className="w-[14.69%] aspect-square mb-[5.56%]">
          <Lottie
            lottieRef={lottieRef}
        ...
        <div className="w-full max-w-[90.10%] mx-auto">
          {/* Business Unit Items - Single Row */}
          <div className="flex justify-center items-start gap-x-[2.08%]">
            {businessUnits.map((unit, index) => (
              ...
              >
                ...
                {/* Business Unit Name */}
                <h3 className="font-bv-celine text-[0.73vw] leading-tight tracking-[0.2em] text-center text-[#D4AF37] mb-[1.11%] uppercase">
                  {t(unit.nameKey)}
                </h3>

                {/* Text description */}
                <p className="font-avenir text-[0.78vw] leading-[1.48vw] text-center text-[#5f5b52] max-w-[19.90vw]">
                  {t(unit.key)}
                </p>
              </div>
            ))}
